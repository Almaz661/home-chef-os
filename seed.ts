...
export async function seed() {
  ...
  if (existingProducts.length === 0) {
    const products = [
      { name: 'Молоко', defaultUnit: 'л', category: 'Молочные' },
      { name: 'Яйца', defaultUnit: 'шт', category: 'Молочные' },
      { name: 'Хлеб', defaultUnit: 'шт', category: 'Выпечка' },
      { name: 'Масло сливочное', defaultUnit: 'г', category: 'Молочные' },
      { name: 'Сыр', defaultUnit: 'г', category: 'Молочные' },
      { name: 'Курица', defaultUnit: 'г', category: 'Мясо' },
      { name: 'Говядина', defaultUnit: 'г', category: 'Мясо' },
      { name: 'Свинина', defaultUnit: 'г', category: 'Мясо' },
      { name: 'Рис', defaultUnit: 'г', category: 'Крупы' },
      { name: 'Гречка', defaultUnit: 'г', category: 'Крупы' },
      { name: 'Макароны', defaultUnit: 'г', category: 'Крупы' },
      { name: 'Картофель', defaultUnit: 'кг', category: 'Овощи' },
      { name: 'Морковь', defaultUnit: 'шт', category: 'Овощи' },
      { name: 'Лук', defaultUnit: 'шт', category: 'Овощи' },
      { name: 'Помидоры', defaultUnit: 'шт', category: 'Овощи' },
      { name: 'Огурцы', defaultUnit: 'шт', category: 'Овощи' },
      { name: 'Чеснок', defaultUnit: 'шт', category: 'Овощи' },
      { name: 'Сахар', defaultUnit: 'г', category: 'Бакалея' },
      { name: 'Соль', defaultUnit: 'г', category: 'Бакалея' },
      { name: 'Мука', defaultUnit: 'г', category: 'Бакалея' },
      { name: 'Растительное масло', defaultUnit: 'мл', category: 'Бакалея' },
      { name: 'Оливковое масло', defaultUnit: 'мл', category: 'Бакалея' },
      { name: 'Сметана', defaultUnit: 'г', category: 'Молочные' },
      { name: 'Творог', defaultUnit: 'г', category: 'Молочные' },
      { name: 'Яблоки', defaultUnit: 'шт', category: 'Фрукты' },
      { name: 'Бананы', defaultUnit: 'шт', category: 'Фрукты' },
      { name: 'Лимон', defaultUnit: 'шт', category: 'Фрукты' },
      { name: 'Томатная паста', defaultUnit: 'г', category: 'Консервы' },
      { name: 'Соевый соус', defaultUnit: 'мл', category: 'Соусы' },
      { name: 'Перец чёрный', defaultUnit: 'г', category: 'Специи' },
    ];
